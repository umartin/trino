        ...
        extends AbstractTestQueryFramework
{
    ...
    void testGeometryWrite()
    {
        try (TestTable table = new TestTable(postgreSqlServer::execute, "test_geometry_write", "(geom geometry)")) {
            assertThat(query("INSERT INTO " + table.getName() + " VALUES (ST_Point (1, 1))"))
    ...
    @Test
    void testGeometryNull()
    {
        try (TestTable table = new TestTable(postgreSqlServer::execute, "test_geometry_null", "(id int, geom geometry)")) {
